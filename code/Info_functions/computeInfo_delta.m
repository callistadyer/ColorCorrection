function [info,infoNormalized] = computeInfo_delta(LMSContrastCalFormat_old, LMSContrastCalFormat_new, imgParams, dichromatType, normalizingValue, Disp, paramsStruct)
% computeInfo_delta  Weighted contrast loss using missing cone contrast as weight
%
% Syntax:
%   [info,infoNormalized] = computeInfo_delta(LMSContrastCalFormat_old, LMSContrastCalFormat_new, imgParams, dichromatType, normalizingValue, Disp, paramsStruct)
%
% Inputs:
