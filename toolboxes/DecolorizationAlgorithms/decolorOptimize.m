function [triLMSCalFormatOpt] = decolorOptimize(triLMSCalFormat, renderType, lambda_var,Disp,bScale)
% Optimizes PCA projections to balance maximizing variance and similarity to original data.
%
% Syntax:
%   [triLMSCalFormatOpt] = decolorOptimize(triLMSCalFormat, renderType, lambda_var,Disp,bScale)
%
% Inputs:
