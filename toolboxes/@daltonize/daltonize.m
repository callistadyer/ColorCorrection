classdef daltonize < handle
    ...
    methods
        ...
        % Compute method
        [LMSDaltonizedCalFormat, rgbLinDaltonizedCalFormat,...
        LMSDaltonizedRenderedCalFormat,rgbLinDaltonizedRenderedCalFormat,...
        transformRGBmatrix_opt, info, infoNormalized, distortion, distortionNormalized] = compute(obj, ...
        ...
        % Generic sweep (info or lambda or distortion)
        [LMSDaltonizedCalFormatSweep, rgbLinDaltonizedCalFormatSweep,...
            LMSDaltonizedRenderedCalFormatSweep,rgbLinDaltonizedRenderedCalFormatSweep,...
        ...
        % Compute info × distortion grid
        [LMSDaltonizedCalFormatGrid, rgbLinDaltonizedCalFormatGrid, ...
            LMSDaltonizedRenderedCalFormatGrid, rgbLinDaltonizedRenderedCalFormatGrid, ...
            transformRGBmatrixGrid, targetInfoNormalizedGrid, targetDistortionNormalizedGrid, ...
            infoNormalizedGrid, distortionNormalizedGrid] = computeInfoDistortionGrid(obj, ...
            LMSCalFormat, imgParams, dichromatType, nInfoSteps, nDistSteps, pathName)
    end
