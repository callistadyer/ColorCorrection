...
[~,~,~,~,infoNormalized_0,~,~] = colorCorrectionOptimize("lambda", 0, LMSCalFormat, imgParams, dichromatType, ...
    obj.infoFcn, obj.distortionFcn, infoNormalizer, distortionNormalizer, Disp);
[~,~,~,~,infoNormalized_1,~,~] = colorCorrectionOptimize("lambda", 1, LMSCalFormat, imgParams, dichromatType, ...
    obj.infoFcn, obj.distortionFcn, infoNormalizer, distortionNormalizer, Disp);
...
for i = 1:nInfoSteps
    ...
    [~,~,T_min, ~, ~, ~, distN_min] = colorCorrectionOptimize( ...
        'targetInfo', thisInfoTarget, LMSCalFormat, imgParams, dichromatType, ...
        obj.infoFcn, obj.distortionFcn, infoNormalizer, distortionNormalizer, Disp, ...
        'T_init', eye(3));   % start from identity 
    ...
    for j = 1:nDistSteps
        ...
        [LMS_ij, rgbLin_ij, T_ij, info_ij, infoN_ij, dist_ij, distN_ij] = colorCorrectionOptimize( ...
            ...
            obj.infoFcn, obj.distortionFcn, infoNormalizer, distortionNormalizer, Disp, ...
            'T_init', T_seed, ...
            'targetDistortion', thisDistTarget, 'epsDistortion', epsDist);
