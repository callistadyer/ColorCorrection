...
class dichromat:
    ...
    def __init__(self, x_size, dichromat_type, grayLMS, wls, T_cones, constraint_wl=None):
        ...
        # To get the missing cone, I project the color onto the dichromat plane.
        # I keep the available cone values fixed, infer where on the plane that puts me
        # and then read off what the missing cone must be at that location.
